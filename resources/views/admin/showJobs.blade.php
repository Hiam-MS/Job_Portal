...
<style>
         ...
         .btn-grad {
          ...
          .btn-grad2 {background-image: linear-gradient(to right, #AA076B 0%, #61045F  51%, #AA076B  100%)}
         .btn-grad2 {
            padding: 6px 6px;
            width :100px;
            text-align: center;
          ...
          .btn-grad3 {background-image: linear-gradient(to right, #000046 0%, #1CB5E0  51%, #000046  100%)}
         .btn-grad3 {
            padding: 6px 6px;
            width :100px;
            text-align: center;
          ...
          .btn-grad4 {background-image: linear-gradient(to right, #870000 0%, #190A05  51%, #870000  100%)}
         .btn-grad4 {
            padding: 6px 6px;
            width :100px;
            text-align: center;
                ...
                <table class="table table-striped">
                  ...
                  @if(count($jobs) > 0)
                            ...
                            @if($item->status == 'pending')
                                <td>
                                    <form action="{{route('accepte_JobStatuse',$item->id)}}" method="POST">
                                            @csrf
                                            <button class="btn-grad unbanFreelancer" data-id="{{$item->id}}">قبول</button>
                                    </form>
                                </td>
                                <td>
                            ...
                            <td>
                                        ...
                                        <button class="btn btn-grad3 unbanFreelancer" data-id="{{$item->id}}">مقبولة</button>
                         ...
                         <button class="btn-grad4 unbanFreelancer" data-id="{{$item->id}}">مرفوضة</button>
