					...
					@csrf
                        ...
                        <div class="form-group">
							...
							@if($errors->any('number_of_employess'))
								<span >{{$errors->first('number_of_employess')}}</span>
							@endif
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<select name="end_job" class="form-control form-control-lg" style="width:100%">
								<option  selected disabled>يرجى الاختيار</option>
								<option value="30" selected>شهر</option>
								<option value="60" {{(old('end_job') && old('end_job')=='60' )?'selected':''}}>شهرين</option>
								<option value="90" {{(old('end_job') && old('end_job')=='90' )?'selected':''}}>ثلاث شهور</option>
